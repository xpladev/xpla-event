...
const Tx = () => {
  ...
  return (
    <div className="min-[769px]:max-w-[947px] min-[1180px]:max-w-full min-[1180px]:w-full max-[768px]:w-full main-shadow bg-white md:p-[30px] p-[8px] flex justify-center items-center rounded-full">
    ...
    <>
      {isLoading ? (
        ...
        <span className="font-pretendard md:text-[32px] md:leading-[38px] text-[14px] leading-[12px] text-[#0080FF]">
          ...
          <ContentCopyIcon
            onClick={() => copyToClipboard(process.env.REACT_APP_TX)}
